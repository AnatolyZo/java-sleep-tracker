...
public class MaxSleepSessionFinderTest {
    public static final DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("dd.MM.yy HH:mm");

    @Test
    public void maxSleepSessionTestIfLongestSessionEquals500() {
        final List<String> sleepSessions = List.of("01.10.25 23:15;02.10.25 07:30;GOOD",
                ...
                "03.10.25 23:40;04.10.25 08:00;BAD", //искомая максимальная сесссия
        ...
        assertEquals(500, function.apply(sleepSessionList));
    }

    @Test
    public void maxSleepSessionTestIfLongestSessionEquals30() {
        final List<String> sleepSessions = List.of("01.10.25 23:15;02.10.25 07:30;GOOD",
                "02.10.25 23:50;03.10.25 06:40;NORMAL",
                "03.10.25 14:10;03.10.25 14:40;NORMAL",
                "03.10.25 23:40;04.10.25 08:00;BAD",
                "04.10.25 21:10;05.10.25 06:20;GOOD");//искомая максимальная сесссия
        ...
        MaxSleepSessionFinder function = new MaxSleepSessionFinder();
        assertEquals(550, function.apply(sleepSessionList));
    }
}
